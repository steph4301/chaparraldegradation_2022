...
unique(seedbank_load_v_omitpretreatment$treatment) # list unique treatments
unique(seedbank_load_v_omitpretreatment$status) # list unique treatments
```
...
```{r transpose for nmds, include=TRUE}
