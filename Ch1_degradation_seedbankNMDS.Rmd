...
(5.1) 
```{r}
stand_sppdiversity <- seedbank_load_v_omitpretreatment %>% 
  group_by()
```


sum of germinates BY GENUS at each stand_core (e.g., present in one core = sum (char, control, oven, charoven)
