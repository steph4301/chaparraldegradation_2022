...
```{r combo columns - canopy height, include = TRUE}
####### START HERE
standheight_full_v$site_rep <- paste(standheight_full$site, standheight_full$Transect_rep, sep="_") # combine site and rep to one column
