...
height_nn <- ggplot(standheight_withcover,
       aes(x = nonnative_grass, y = height_cm, color = site)) +
  geom_point() +
  geom_jitter() +
  theme(axis.text.x.bottom = element_text(angle = 90)) +
  labs(x = "Non-native Grass Cover (%)", 
...
summary(lm(height_cm ~ nonnative_grass, data = standheight_withcover))
# Residual standard error: 67.34 on 613 degrees of freedom
# Multiple R-squared:  0.1138,	Adjusted R-squared:  0.1123 
# F-statistic: 78.68 on 1 and 613 DF,  p-value: < 2.2e-16
