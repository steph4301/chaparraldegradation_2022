...
ggplot(data = abcover_vegcover_long, aes(y = percentcover, x = standtype, fill = covertype)) +
    geom_boxplot() # boxplots
ggplot(data = abcover_vegcover_long, aes(y = percentcover, x = standtype, color = covertype)) + 
  geom_jitter()
...
# jitter code
ggplot(data = abcover_vegcover_long, aes(x = standtype, y = percentcover, color = covertype))+ #start with the raw data
...
#W = 0.90228, p-value = 0.0001246 <-- not normally distributed
