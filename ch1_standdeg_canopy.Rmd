...
shrubspp_leaftype_cover <- shrubspp_leaftype %>% 
...
view(shrubspp_leaftype_cover)
write.csv(shrubspp_leaftype_cover,"processed/shrubspp_leaftype_cover.csv")
```
...
leaftype_nngrass_figure <- ggplot(data = shrubspp_leaftype_cover, 
       aes(x = nonnative_grass*100, y = sum_leaftype_cover, color = leaftype)) +
  geom_point(size = 3, alpha = 0.8) +
...
#  geom_smooth(method = "lm", se = FALSE, linetype = "solid", color = "black") +  # lm, loess, glm
  ...
  labs(x = "Non-native grass cover (%)",
       y = "Percent cover (%)",
       title = "Shrub cover by leaf type over non-native grass cover") +
  theme_bw() 
  # stat_poly_line() +
  # stat_poly_eq(use_label(c("eq", "R2")))
