...
```{r MEAN totalvegcover, include=TRUE}
#testing for normality
shapiro.test(abcover_vegcover_long$percentcover)
# qqPlot(abcover_vegcover_long$percentcover) # error

ggqqplot(abcover_vegcover_long$percentcover)
...
```{r STATS totalvegcover, include=FALSE}

# by SITE
summary(aov(percentcover_veg ~ site, data = abcover_vegcover))
# Df   Sum Sq   Mean Sq F value Pr(>F)
# site         6 0.004125 0.0006874   1.156  0.413
# Residuals    8 0.004759 0.0005949 

TukeyHSD(aov(percentcover_veg ~ site, data = abcover_vegcover))
#   Tukey multiple comparisons of means
#     95% family-wise confidence level
# 
# Fit: aov(formula = percentcover_veg ~ site, data = abcover_vegcover)
# 
# $site
#                            diff         lwr        upr     p adj
# DEG2-DEG1         -8.130081e-03 -0.08415896 0.06789879 0.9993832
# ENH1-DEG1         -1.626016e-02 -0.09228904 0.05976871 0.9761030
# ENH2-DEG1         -3.252033e-02 -0.10854920 0.04350855 0.6696893
# Intact_1-DEG1     -4.878049e-02 -0.15630155 0.05874058 0.6167821
# Intact_2-DEG1     -4.878049e-02 -0.15630155 0.05874058 0.6167821
# Intact_3-DEG1      0.000000e+00 -0.10752107 0.10752107 1.0000000
# ENH1-DEG2         -8.130081e-03 -0.08415896 0.06789879 0.9993832
# ENH2-DEG2         -2.439024e-02 -0.10041912 0.05163863 0.8667146
# Intact_1-DEG2     -4.065041e-02 -0.14817147 0.06687066 0.7679756
# Intact_2-DEG2     -4.065041e-02 -0.14817147 0.06687066 0.7679756
# Intact_3-DEG2      8.130081e-03 -0.09939098 0.11565115 0.9999156
# ENH2-ENH1         -1.626016e-02 -0.09228904 0.05976871 0.9761030
# Intact_1-ENH1     -3.252033e-02 -0.14004139 0.07500074 0.8931131
# Intact_2-ENH1     -3.252033e-02 -0.14004139 0.07500074 0.8931131
# Intact_3-ENH1      1.626016e-02 -0.09126090 0.12378123 0.9958564
# Intact_1-ENH2     -1.626016e-02 -0.12378123 0.09126090 0.9958564
# Intact_2-ENH2     -1.626016e-02 -0.12378123 0.09126090 0.9958564
# Intact_3-ENH2      3.252033e-02 -0.07500074 0.14004139 0.8931131
# Intact_2-Intact_1  1.110223e-15 -0.13168587 0.13168587 1.0000000
# Intact_3-Intact_1  4.878049e-02 -0.08290539 0.18046636 0.7823082
# Intact_3-Intact_2  4.878049e-02 -0.08290539 0.18046636 0.7823082
```
...
## jitter - by site_rep
ggplot(data = abcover_bylf_bystatus, aes(y = percentcover, x = site_rep, color = lifeform)) + 
  geom_jitter()
ggplot(data = abcover_bylf_bystatus, aes(y = percentcover, x = lifeform, color = standtype)) + 
  geom_jitter()

ggplot(data = abcover_bylf_bystatus, aes(y = percentcover, x = standtype, color = status)) + 
  geom_jitter()
## boxplot
ggplot(data = abcover_bylf_bystatus, aes(y = percentcover, x = standtype, fill = lifeform)) +
    geom_boxplot() # boxplots

## jitter - by standtype
ggplot(data = abcover_bylf_bystatus, aes(y = percentcover, x = standtype, color = lifeform)) + 
  geom_jitter()
ggplot(data = abcover_bylf_bystatus, aes(y = percentcover, x = standtype, color = status)) + 
  geom_jitter()
## boxplot
...
ggplot(data = cover_statuslf_matrix_wide1, 
...
natforb_grass_scatter
nnforb_grass_scatter


# print the plots into a single figure
grid.arrange(natforb_grass_scatter, nnforb_grass_scatter, ncol = 1, nrow = 2)


ggsave("Ch1_Degradation_figures/natforb_grass_scatter.png", natforb_grass_scatter, width = 8, height = 6)
ggsave("Ch1_Degradation_figures/nnforb_grass_scatter.png", nnforb_grass_scatter, width = 8, height = 6)
```
