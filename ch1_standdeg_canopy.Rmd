...
TukeyHSD(aov((cov ~ site_rep) , data = standheight_cov), conf.level=.95) 
#$standtype
#                       diff        lwr         upr     p adj
...
```{r canopy COV linear regression}
...
ggplot(data = standheight_cov_cover, 
       aes(x = native_shrub*100, y = cov, color = site_rep)) + #color = standtype
  geom_point(size = 3, alpha = 0.8) +
  ylim(0, 1)+
  xlim(0,100) +
  geom_smooth(method = "lm", se = FALSE, linetype = "solid", color = "black") +  # lm, loess, glm
...
ggplot(data = standheight_cov_cover, 
       aes(x = nonnative_grass*100, y = cov, color = site_rep)) + #color = standtype
  geom_point(size = 3, alpha = 0.8) +
  ylim(0, 1)+
  xlim(0,100) +
  geom_smooth(method = "lm", se = FALSE, linetype = "solid", color = "black") +  # lm, loess, glm
...
# F-statistic: 2.903 on 1 and 13 DF,  p-value: 0.112
```
