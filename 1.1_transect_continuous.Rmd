...
######################################## FIGURES
fig_bareground_all <- ggplot(data = groundcover_percent) +
...
hist(density_cover$sum_density_m2) # denspp_cover
