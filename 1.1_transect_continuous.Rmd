...
geom_point(aes(x = shrub_native * 100, y = grass_native * 100), size = 3, shape = 3, show.legend = TRUE) +
 geom_smooth(aes(x = shrub_native * 100, y = grass_native * 100, color = "grass_native"),
             method = "lm", se = TRUE, linetype = "solid", show.legend = TRUE) +
  geom_point(aes(x = shrub_native * 100, y = grass_nonnative * 100), size = 3, shape = 16 , show.legend = TRUE) +
...
fig.1a_labeled <- ggdraw(fig.1a) + draw_label("C", x = 0.85, y = 0.92, size = 15)  # Add letter "A" in the top-right corner
#fig.1b_labeled <- ggdraw(fig.1b) + draw_label("D", x = 0.85, y = 0.92, size = 15)  
fig.1c_labeled <- ggdraw(fig.1c) + draw_label("E", x = 0.85, y = 0.92, size = 15)  # Add letter "B"
fig.1d_labeled <- ggdraw(fig.1d) + draw_label("B", x = 0.85, y = 0.92, size = 15)  # Add letter "C"
fig.1e_labeled <- ggdraw(fig.1e) + draw_label("D", x = 0.85, y = 0.92, size = 15)  # Add letter "D"
fig.1f_labeled <- ggdraw(fig.1f) + draw_label("A", x = 0.85, y = 0.92, size = 15)  # Add letter "E"

# Combine the plots in a 2x3 layout
grid.arrange(fig.1f_labeled, fig.1a_labeled, 
             fig.1d_labeled, fig.1e_labeled, 
             NULL, fig.1c_labeled,
             nrow = 3, 
             ncol = 2, 
