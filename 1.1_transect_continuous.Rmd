...
# ssG  0.8354 -      -      -     
# ssF  0.0080 1.0000 -      -     
# ssFG 0.0024 0.0053 0.1061 -     
# EVG  0.0114 0.0271 0.3412 1.0000
...
# 2 NNG                    0     0      0   a
# 5 ssG                    6.1   0     19.5 ab
# 3 ssF                    9.76  7.32  26.8 bc
# 4 ssFG                  46.3  39.0   57.9 c
# 1 EVG                   46.3  34.2   78.0 c
...
#  * <chr>            <chr>  <chr>  <int> <int>     <dbl>    <dbl> <dbl> <chr>       
#  1 nonnative_thatch NNG    ssG       10    10      80.5 0.022    0.221 ns          
#  2 nonnative_thatch NNG    ssF       10     7      62   0.009    0.092 ns          
#  3 nonnative_thatch NNG    ssFG      10     8      79   0.000581 0.006 **          
#  4 nonnative_thatch NNG    EVG       10     5      50   0.002    0.025 *      
#       
#  5 nonnative_thatch ssG    ssF       10     7      45.5 0.328    1     ns          
#  6 nonnative_thatch ssG    ssFG      10     8      77   0.001    0.012 *           
#  7 nonnative_thatch ssG    EVG       10     5      50   0.003    0.027 *        
#     
#  8 nonnative_thatch ssF    ssFG       7     8      50   0.013    0.127 ns          
#  9 nonnative_thatch ssF    EVG        7     5      35   0.006    0.057 ns     
#       
# 10 nonnative_thatch ssFG   EVG        8     5      34   0.047    0.472 ns  
...
# 2 NNG               90.2  84.2   90.2 a
# 5 ssG               67.1  63.4   81.7 a
# 3 ssF               73.2  42.7   75.6 ab
# 4 ssFG              29.3  25.6   37.2 bc
# 1 EVG                4.88  2.44  22.0 bc
