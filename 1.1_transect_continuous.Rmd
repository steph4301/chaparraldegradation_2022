...
#   
#   stat_pvalue_manual(significance_results, label = "p.adj.signif", y.position = "y.position") + ##### BREAKS CODE
#   
...
############# BROKEN CODE FOR SIGNIFICANCE LETTERS - START
# # Generate compact letter display for significance
# p_values_git <- significance_results$p.adj  # Adjusted p-values
# names(p_values_git) <- significance_results$comparison  # Set names to comparisons
# # Generate compact letter display
# cld <- multcompLetters(p_values_git)
# print(cld$Letters)
# 
# significance_letters <- significance_results %>%
#   rstatix::get_comparisons() %>%
#   rstatix::add_significance()  # No 'method' argument
# 
# significance_letters <- significance_results %>%
#   rstatix::get_comparisons() %>%
...
############# BROKEN CODE FOR SIGNIFICANCE LETTERS - END
