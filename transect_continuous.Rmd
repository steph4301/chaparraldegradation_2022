...
new.specieslist <- specieslist %>%
  add_row(species = "", 
          ...
          lifecycle = "",
          family = "")
# Mirabilis Laevis is in both, but the species list has is as "mirabilis laevis var. crassifolia"
# Blitum californicum and Sambucus nigra are in abcover but not species list
# Sambucus mexicana is in species list but not in abcover (i dont know why this would be)
