...
ggplot(data = cover_bylfstatus, aes(y = percentcover*100, x = site, color = lifeform_status)) + geom_jitter() + facet_wrap(~lifeform_status)
...
This is the spread of non-native grass cover by native shrub cover... 
...
... and native shrub cover by non-native grass cover.
