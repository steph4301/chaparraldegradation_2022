...
#  Group 1  #sps.  1 
#                  A   B  stat p.value   
# Croton setiger 1.0 0.5 0.707    0.01 **
# 
#  Group 2  #sps.  5 
#                                 A      B  stat p.value   
# Malacothamnus fasciculatus 0.8594 1.0000 0.927   0.005 **
# Centaurea melitensis       0.7596 1.0000 0.872   0.005 **
# Typha domingensis          0.8829 0.7778 0.829   0.005 **
# Sonchus oleraceus          0.8101 0.5556 0.671   0.020 * 
# Avena spp.                 0.9256 0.4444 0.641   0.035 * 
# 
#  Group 3  #sps.  11 
#                                    A      B  stat p.value   
# Stipa lepida                  0.9721 1.0000 0.986   0.005 **
# Artemisia californica         0.8895 1.0000 0.943   0.005 **
# Pseudognaphalium californicum 1.0000 0.8889 0.943   0.005 **
# Erigeron canadensis           0.9848 0.8889 0.936   0.005 **
# Eucrypta chrysanthemifolia    0.9701 0.8889 0.929   0.005 **
# Nicotiana glauca              0.9204 0.8889 0.904   0.005 **
# Apiastrum angustifolium       1.0000 0.7778 0.882   0.010 **
# Claytonia spp.                1.0000 0.6667 0.816   0.005 **
# Malacothrix saxatilis         1.0000 0.5556 0.745   0.010 **
# Ribes malvaceum               1.0000 0.5556 0.745   0.015 * 
# Phacelia spp.                 0.9799 0.5556 0.738   0.035 * 
# 
#  Group 1+2  #sps.  3 
#                          A      B  stat p.value   
# Hirschfeldia incana 1.0000 0.8824 0.939   0.005 **
# Erodium spp.        1.0000 0.7647 0.874   0.005 **
# Acmispon spp.       0.9661 0.7647 0.860   0.020 * 
# 
#  Group 2+3  #sps.  2 
#                         A      B  stat p.value   
# Festuca myuros     1.0000 0.7222 0.850   0.005 **
# Salvia leucophylla 1.0000 0.5556 0.745   0.020 * 
# ---
...
# $group
#            diff         lwr         upr     p adj
# 2-1 -0.10959209 -0.22252937 0.003345181 0.0583159 <-- 2 and 1
# 3-1  0.02930223 -0.08363504 0.142239508 0.7943526
# 3-2  0.13889433  0.02932908 0.248459576 0.0113293 <-- 2 and 1
...
# 50 genera <-- 51 - 1 for unknown 


################## family richness 

length(sort(unique(seedbank_load_v$family))) - 1
# n = 26 <-- 27 families - unknown family
...
#  sdbk_clust   n_soilcores   natforbspp_rich_mean    natforbspp_rich_SD
#  1                    8                 2.88              0.835
#  2                    9                 5                 1.58 
#  3                    9                 8.22              1.64 
...
# [3] "Galium porrigens"          "Trifolium gracelentum"    
# [5] "Trifolium willdenovii"     "Unknown E - plastic plant"
...
# [1] "Acmispon maritimus"      "Astragalus trichopodus"  "Emmenanthe penduliflora"

### in soil cluster 1 and 3
L13 <- list(natforb_spp1$species_diversity, natforb_spp3$species_diversity)
Reduce(intersect, L13)
# [1] "Astragalus trichopodus"     "Cryptantha spp."           
# [3] "Emmenanthe penduliflora"    "Erigeron canadensis"       
...
# [1] "Acmispon glaber"         "Astragalus trichopodus"  "Emmenanthe penduliflora"
...
seedbankgerm_cluster <- seedbankgerm_cluster_prep %>%  
  ...
  summarise(sum_seedden = sum(n_per_g), 
            n = length(stand_core_depth_treat))

hist(seedbankgerm_cluster$sum_seedden)

median_seedgermcluster <- seedbankgerm_cluster %>% 
   group_by(species_diversity, status, lifescycle, lifeform, family, sdbk_clust) %>% 
  summarise(median_seedden = median(sum_seedden), 
            n_soilcores = length(sum_seedden))

# species, status, lifecycle, lifeform, family, DEG, MTX, INT
# 
