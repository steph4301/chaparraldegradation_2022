...
#write.csv(ab_diversity_native_nn, "processed/ab_diversity_native_nn.csv")
...
belttrans_sppr %>% 
  dplyr::filter(site == "ENH2") %>% 
  print(unique(belttrans_sppr$species))
...
```{r belt transect sppr figure, include = TRUE}
