...
#beltrans_density <- read.csv("processed/shrubdensitylife_transposed.csv", header = TRUE, na.strings=c("","NA"))
...
sort(unique(beltrans_sppr$site_rep))
sort(unique(beltrans_sppr$species))
