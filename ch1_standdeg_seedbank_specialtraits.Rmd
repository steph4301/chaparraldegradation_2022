...
# site    total_germination   average_germ_pergsoil
# INT1	    10    	            0.005		
# INT2    	7	                  0.005		
# INT3    	11	                0.004		
# ENH1	    9	                  0.004		
...
```{r total germination stats}
### STEPHANIE START HERE (jan 14) --> check data for normality. If not normally distributed, run KW and post-hoc comparison. To determine: do ENH and INT hillslopes have sig different fire following seed densities? or are they the same?

### copy normality test from seedbank.Rmd
