...
# Germination of fire following species
...
```{r seed density by nn grass cover}
ggplot(data = seedbank_fire, 
...
# site differences combining surface and below germination data
```{r explore fire following seedbanks MEAN germination, include=TRUE}
seedbank_fire_totalemerg <- seedbank_fire %>% 
  na.omit() %>%
  group_by(site, soilcore) %>% 
  summarise(sum_germination_g = round(sum(n_per_g),4)) %>% 
  mutate(sum_germ_g_log = log(sum_germination_g))
#  site  stand_core sum_germination_g
#    <fct> <fct>                  <dbl>
#  1 INT1  INT1_1                0.0393
#  2 INT1  INT1_3                0.0118
#  3 INT2  INT2_5                0.0061
#  4 INT2  INT2_6                0.0218
#  5 INT3  INT3_7                0.029 
#  6 INT3  INT3_8                0.0061
#  7 INT3  INT3_9                0.0122
#  8 ENH1  ENH1_1                0.0173
#  9 ENH1  ENH1_4                0.0086
# 10 ENH2  ENH2_6                0.0058
# 11 ENH2  ENH2_7                0.0058
# 12 ENH2  ENH2_8                0.0086
# 13 ENH2  ENH2_9                0.0086
# 14 ENH2  ENH2_10               0.0029

# calculating avergerge germination by combining surface and deep soil cores
...
# site         4  2.867  0.7167   1.703  0.233
