...
# Load data
- data prep was completed in 1_transect_continuous.Rmd, ~line 1-300
...
abcover_full_v_omitground <- abcover_charateristics_load %>% 
  ...
  ##### 
  #####
  mutate(species = case_when(species == "Acmispon glaber dead" ~ "Acmispon glaber", # old name ~ new name
                             ...
                             species == "Erodium cicutarium" ~ "Erodium spp.", # combine Erodium to Erodium spp.
