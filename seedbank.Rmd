...
germ_tray_NAT %>% 
  ...
  summarize(mean_NATseeddensity = mean(seeds_per_g), 
            SD = ) ##### STEPHANIE START HERE by calculating SD for your mean native seed density/g of soil, you stopped here on January 12, 2024
# depth_name  mean_NATseeddensity
# deep	      0.01190290			
# surface	    0.03344313	
```
