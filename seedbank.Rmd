...
germ_tray_prep2 <- germ_tray_prep %>% 
...
qplot(germ_tray, pm25, data = pollution, facets = . ~ region)
```
...
# Kruskal-Wallis chi-squared = 64.181, df = 6, p-value = 6.338e-12 <-- not normally distributed
...
# Kruskal-Wallis chi-squared = 65.903, df = 1, p-value = 4.737e-16
