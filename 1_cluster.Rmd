...
spp <- genp %>% 
  ...
  filter(species == "Lupinus.spp."| 
         species == "Festuca.myros"| 
         species == "Heteromeles.arbutifolia"|
         species == "Rhus.ovata"|
         species == "Rhamnus.ilicifolia"|
         species == "Hirschfeldia.incana"| 
         species == "Centaurea.melitensis"| 
         species == "Avena.barbata"|
         species == "Stipa.lepida"|
         species == "Bromus.rubens"| 
         species == "Bromus.diandrus") %>%  # <- indicator species (n = 11) 
  mutate(species = case_when(
    species == "Lupinus.spp." ~ "Lupinus spp.", 
    species == "Festuca.myros" ~	"Festuca myuros", 
    species == "Heteromeles.arbutifolia" ~ "Heteromeles arbutifolia",
    species == "Rhus.ovata" ~ "Rhus ovata",
    species == "Rhamnus.ilicifolia" ~ "Rhamnus ilicifolia",
    species == "Hirschfeldia.incana" ~ "Hirschfeldia incana",
    species == "Centaurea.melitensis" ~ "Centaurea melitensis",
    species == "Avena.barbata" ~"Avena barbata",
    species == "Stipa.lepida" ~ "Stipa lepida",
    species == "Bromus.rubens" ~ "Bromus rubens",
    species == "Bromus.diandrus" ~ "Bromus diandrus",
    TRUE ~ species))
...
# all species in one nmds
nmds_all <- ggplot(mds.df,
       aes(x = NMDS1,
           y = NMDS2
           )) +
  geom_point(size = 3, alpha = 0.8, aes(color = sub_grp, shape = sub_grp, fill = sub_grp)) +
