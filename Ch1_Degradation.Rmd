...
# percent cover
abcover_full <- read.csv("~/Dropbox/GRADSCHOOL/Dissertation/R_dissertation/GitHub/https:/github.com/steph4301/chaparraldegradation_2022.git/deg_percentcover_byspecies_bylifeform.csv", header = TRUE, na.strings=c("","NA"))
